              ...
              <CardContent className="flex aspect-square items-center justify-center p-6">
                <div className="s-phone:grid s-phone:gap-4">
                  ...
                  <p className="s-phone:text-sm">
                    ...
                    superfoods, nuts, seeds, and granola options to create your
                    perfect blend.
                  </p>
                </div>
              </CardContent>
            ...
            <Card>
              <CardContent className="flex aspect-square items-center justify-center p-6">
                <div className="s-phone:grid s-phone:gap-4">
                  ...
                  <p className="s-phone:text-sm">
                    Simplify your grocery shopping with our integrated shopping
                    list feature. Add ingredients from your favorite recipes
                    with a single tap, and never miss an essential item again.
                  </p>
                </div>
              </CardContent>
            </Card>
              ...
              <CardContent className="flex aspect-square items-center justify-center p-6">
                <div className="s-phone:grid s-phone:gap-4">
                  ...
                  <p className="s-phone:text-sm">
                    ...
                    calories, vitamins, minerals, and macronutrients
                    effortlessly.
                  </p>
                </div>
              </CardContent>

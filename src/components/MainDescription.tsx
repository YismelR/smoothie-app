...
export default function MainDescription() {
  return (
    <div className="flex flex-col gap-8  md-tablet:pl-16 lg-phone:pl-8 ">
      ...
      <div>
        <button className="bg-[#DF4062] py-2 px-4 rounded-full text-white shadow-3xl hover:bg-[#FFA4C7] md-desktop:text-xl lg-desktop:text-3xl s-laptop:text-xs md-laptop:text-sm md-tablet:text-base lg-desktop:py-4 lg-desktop:px-6 lg-phone:text-sm md-phone:text-sm s-phone:text-xs">
          Order Now
        </button>
      </div>

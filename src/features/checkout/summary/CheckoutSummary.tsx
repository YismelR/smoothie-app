...
export default function CheckoutSummary() {
  return (
    <div className="flex flex-col md-tablet:grid md-tablet:grid-cols-2 md-tablet:p-8 md-tablet:gap-4 s-laptop:p-12 md-laptop:px-32 justify-center md-laptop:gap-4 md-desktop:gap-8 md-laptop:grid-cols-3">

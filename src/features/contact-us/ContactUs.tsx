...
export default function ContactUs() {
  ...
  return (
    <div className=" s-phone:pb-16 lg-desktop:pb-28 s-phone:px-4 s-phone:grid s-phone:gap-4 s-phone:mt-4 md-tablet:place-items-center md-tablet:px-12 s-laptop:grid-cols-2 s-laptop:my-12 md-laptop:pl-32 md-laptop:pr-24 md-desktop:my-32 md-desktop:pr-16 lg-desktop:h-[50rem] lg-desktop:my-0 lg-desktop:mt-24">

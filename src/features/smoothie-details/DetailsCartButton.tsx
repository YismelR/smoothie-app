...
export default forwardRef(function DetailsCartButton(
  ...
  return (
    <DialogTrigger asChild>
      <Button
        variant="outline"
        className={`text-white ${smoothie.hoverColor}  ${smoothie.backgroundColor} px-4 py-2 shadow-3xl ${smoothie.shadowBtnColor} rounded-[2rem] cursor-pointer lg-phone:text-xl md-tablet:text-2xl s-laptop:text-xl md-laptop:text-2xl md-desktop:py-7 lg-desktop:text-4xl lg-desktop:py-8`}

...
export default function HomeMain() {
  return (
    <main className="grid grid-cols-2 ">
      ...
      <div className="flex flex-col place-items-center md-laptop:justify-around md-laptop:pr-0 s-laptop:pr-4 ">
        <img
          src={mainBowl}
          alt="smoothie bowl"
          className=" shadow-2xl rounded-full md-desktop:w-4/5"
        />
        <button className="relative bg-[#DF4062] w-24 h-10 rounded-full md-laptop:place-self-start shadow-3xl mt-8 md-desktop:w-32 md-desktop:h-12 lg-desktop:w-36 lg-desktop:h-16">
          <img
            src={arrow}
            alt="arrow next"
            className="absolute -right-6 top-2 md-desktop:w-20 md-desktop:-right-9 lg-desktop:top-4"
          />
        </button>
        <div className="flex place-self-end gap-4 md-laptop:pr-14 s-laptop:flex-auto s-laptop:pr-0">
          <img
            src={facebook}
            alt="facebook"

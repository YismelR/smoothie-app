...
export default function SmoothieDetails() {
  ...
  return (
    <div className="s-phone:pb-8">
      ...
      <div className="s-phone:flex s-phone:flex-col s-phone:gap-8 s-phone:pl-4 s-phone:pr-4 md-tablet:px-12 s-phone:mt-4 s-laptop:mt-12 md-desktop:mt-20 md-laptop:pl-20 md-laptop:pr-32">

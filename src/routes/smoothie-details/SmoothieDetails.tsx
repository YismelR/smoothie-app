  ...
  return (
    <>
      ...
      <div className="s-phone:flex flex-col place-items-center px-8 md-tablet:px-12 s-laptop:grid grid-cols-2 s-laptop:mt-20 md-laptop:pl-20 md-laptop:pr-32">
        <CarouselDemo />
        <div className="flex flex-col gap-4 py-4 lg-phone:gap-12 s-laptop:px-8 md-desktop:px-16">
          <div className="flex justify-between place-items-center">
            <h1 className="s-phone:text-lg font-semibold lg-phone:text-2xl md-tablet:text-3xl md-desktop:text-5xl">
          ...
          <p className="s-phone:text-xs md-phone:text-sm lg-phone:text-base md-tablet:text-xl md-desktop:text-2xl">
          ...
          <div className="lg-phone:flex flex-col gap-2">
            <p className="font-medium lg-phone:text-xl md-tablet:text-2xl md-desktop:text-3xl">
              Price $18
            </p>
